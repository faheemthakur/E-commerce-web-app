...
<div class="container border border-5">
    <div class="row">
        <div class="col">
            <h3 class="display-6"><?php echo $_SESSION['store_name']?></h3>
        </div>
        <hr>
    </div>
    <div class="row">
        <div class="col mt-5">
            ...
            <button type="button" class="btn btn-primary"><a href="sellerproduct.php">View</a></button>
    </div>
    <div class="row">
        <div class="col mt-5">
            <p>To add a product.</p>
            <button type="button" class="btn btn-primary"><a href="addproduct.php">add</a></button>
        </div>
        <div class="row">
        <div class="col mt-5">
            <p>View Orders.</p>
            <button type="button" class="btn btn-primary"><a href="sellerorders.php">View Orders.</a></button>
        </div>
    </div>
            ...
            <div class="row">
              <div class="col">
                  <div class="col mt-5">
                      <p>To Log Out</p>
                      <button type="button" class="btn btn-primary"><a href="logout.php">Click Here</a><button>
                  </div>
              </div>
          </div>
    </div>
