...
<html lang="en">
  ...
  <body>
    ...
    <h3 class="display-6 text-center pb-5"><b>Wishlist.</b></h3>
            ...
            <table class="table">
                ...
                while($rows=$result->fetch_assoc())
                {
                  ...
                  <?php
                    ...
                    <td>".$rows['seller_shop']."</td>
                    <td>".$rows['shop_location']."</td>
                    <td>".$rows['store_contact_no']."</td>
                    <td><a href='wishlistdelete.php?sno=$rows[sno]'>Delete</a></td>
                    ";               
                ?>
                  </tr>
                  <?php
