...
<html lang="en">
  ...
  <body>
    ...
    <div class="row">
        <div class="col">
            <h3 class="display-6"><b>Create a seller Account.</b></h3>
            <form action="becomeasellerinsert.php" method="post">
                <div class="mb-3 mt-4">
                  <label for="exampleInputEmail1" class="form-label">Enter Seller Name.</label>
                  <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="esn">
                  <div id="emailHelp" class="form-text">Eg: TRM Essentials.</div>
                </div>

                <div class="mb-3 mt-4">
                    <label for="exampleInputEmail1" class="form-label">Enter Seller Address.</label>
                    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="esa">
                    <div id="emailHelp" class="form-text">Eg: Margao.</div>
                </div>

                <div class="mb-3 mt-4">
                    <label for="exampleInputEmail1" class="form-label">Enter Contact No.</label>
                    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"name="ecn">
                    <div id="emailHelp" class="form-text"></div>
                </div>

                <div class="mb-3">
                    <div class="mb-3 mt-4">
                        <label for="exampleInputEmail1" class="form-label">Choose an ID.</label>
                        <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="id">
                        <div id="emailHelp" class="form-text">Eg: TRMEssentials123.</div>
                    </div>
