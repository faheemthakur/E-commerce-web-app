...
<html lang="en">
  ...
  <body>
    ...
    <div class="row">
        <div class="col">
            <h3 class="display-6"><b>Status</b></h3>
            <form action="statusinsert.php" method="GET" >
            <div class="mb-3 mt-4">
                  <label for="exampleInputEmail1" class="form-label">Order no.</label>
                  <input value="<?php echo "$order_no" ?>"type="Message" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="order_no" readonly>
                </div>
                <div class="mb-3 mt-4">
                    <label for="exampleInputEmail1" class="form-label">Enter Status</label>
                    <input value="<?php echo "$order_status" ?>" type="Message" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="order_status">
                </div>
