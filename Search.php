...
if(isset($_POST['search']))
{
    ...
    $query = "SELECT product.`Serial_no`,product.`product_name`,product.`product_id`,product.`product_subcat`,product.`price`,store.store_name,store.store_contact_no,store.store_address
    FROM product 
    INNER JOIN store
    WHERE store.store_name OR product.`product_name`
     LIKE '%".$valueToSearch."%'";
            ...
            <table class="table">
                ...
                <?php while($row = mysqli_fetch_array($search_result)):?>
                  <tr>
                    ...
                    <td>  <a href="Product.html">..</a><?php echo $row['product_id'];?></td>
                    <td><?php echo $row['product_subcat'];?></td>
                    <td><?php echo $row['store_name'];?></td>
                    <td><?php echo $row['store_address'];?></td>
                    <td><?php echo $row['store_contact_no'];?></td>
