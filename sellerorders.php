...
$sql = "SELECT * FROM `orders` WHERE  seller_id='".$_SESSION["store_id"]."' ;";
...
<html lang="en">
  ...
  <body>
    <nav class="navbar sticky-top navbar-expand-sm navbar-dark" style="background-color: #415e74;">
      ...
      <div class="row">
        <div class="col">
            <h3 class="display-6 text-center pb-5">Orders.</h3>
        </div>
            ...
            <table class="table">
                ...
                while($rows=$result->fetch_assoc())
                {
                  ...
                  <tr>
                    ...
                    <td>".$rows['quantity_purchased']."</td>
                    <td>".$rows['order_status']."</td>
                    <td><a href='changestatus.php?order_status=$rows[order_status]&order_no=$rows[order_no]'>Change Status</a></td>
                    ";
                    ?>
