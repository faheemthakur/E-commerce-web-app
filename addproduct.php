...
<html lang="en">
  ...
  <body>
    ...
    <div class="row">
        <div class="col">
            <h3 class="display-6"><b>Add Product</b></h3>
            <form action="prodinsert.php" method="post">
                <div class="mb-3 mt-4">
                  <label for="exampleInputEmail1" class="form-label">Enter Product ID.</label>
                  <input type="Message" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="prodID">
                </div>
                <div class="mb-3 mt-4">
                    <label for="exampleInputEmail1" class="form-label">Enter Product Name.</label>
                    <input type="Message" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="prodname">
                </div>
                <div class="mb-3 mt-4">
                    <label for="exampleInputEmail1" class="form-label">Product Category.</label>
                    <input type="Message" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="prodcat">
                </div>
                <div class="mb-3 mt-4">
                    <label for="exampleInputEmail1" class="form-label">Product Subcategory.</label>
                    <input type="Message" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="subcat">
                </div>
                <div class="mb-3 mt-4">
                    <label for="exampleInputEmail1" class="form-label">Product Seller Id.</label>
                    <input type="Message" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="sellerID">
                </div>
                <div class="mb-3 mt-4">
                    <label for="exampleInputEmail1" class="form-label">Product Status.</label>
                    <input type="Message" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="prodstatus">
                </div>
                <div class="mb-3 mt-4">
                ...
                <div class="mb-3 mt-4">
                    ...
                    <input type="Message" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="prodloc">
                </div>
                <div class="mb-3 mt-4">
                    <label for="exampleInputEmail1" class="form-label">Product Price.</label>
                    <input type="Message" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="prodprice">
                </div>
                <div class="mb-3 mt-4">
                    <label for="exampleInputEmail1" class="form-label">Image.</label>
                    <input type="file" name="image" accept=".jpg,.jpeg,.png" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" >
                </div>
