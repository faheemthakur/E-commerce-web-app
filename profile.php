...
?>
   ...
   <div class="row ">
   <div class="col-4"></div>
    <div class="col-4 text-center border border-5">
        <form action="changeusername.php" method="POST">
      <h3 class="display-6 text-center">Personal Information.</h3>
      <p>Change username to</p>
      <input type="text" id="text1" name="username">
      <button name="submit1"type="submit" id="one"> Change Username</button>
</form>
      <form action="changepassword.php" method="POST">
      <p class="mt-5">Enter Password </p>
      <input type="password" id="password123"name="password">
      <button type="submit" id="chngpw">Change Password.</button><br>
</form>
    </div>
    <div class="col-4 ">
