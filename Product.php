                ...
                <div class="col">
                    <table class="table">
                        ...
                        echo"
                              ...
                              <td>".$scno."</td>
                              <td>".$price."</td>
                              <td><a href='wishlistinsert.php?sno=$sno&pname=$pname&pid=$pid&sname=$sname&saddress=$saddress&sno=$scno&scno=$sno&'>
                              Wishlist</td>
                              <td><a href='ordersinsert.php?pname=$pname&psid=$psid'>buy</td>
                              ";
                          }
                          ?>    
